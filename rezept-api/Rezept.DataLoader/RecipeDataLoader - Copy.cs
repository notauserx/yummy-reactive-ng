...
public class RecipeDataLoaderCopy : IDisposable
{
    private readonly ParsedResult result;

    private readonly RezeptDbContext context;
    private RecipeDataLoaderCopy(RezeptDbContext context, ParsedResult result)
    {
    ...
    public static RecipeDataLoaderCopy CreateDefault(ParsedResult result)
    {
        ...
        return new RecipeDataLoaderCopy(context, result);
    }
